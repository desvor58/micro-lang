...
void micro_codegen_386_init(micro_codegen_t *codegen, micro_tok_vec_t *toks)
{
    codegen->toks = toks;
    codegen->toks_pos = 0;
    codegen->outbuf = malloc(sizeof(micro_codegen_outbuf_t));
    micro_codegen_outbuf_init(codegen->outbuf);
