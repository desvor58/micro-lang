    ...
    if (_micro_expr_is_op(start->type)) {
        ...
        if (op_info.is_cond) {
            ...
            if (dst.type == MICRO_STORAGE_REG) {
                ...
                push_asm_instr(MICRO_ASM386_INSTR_MOVZX_R32R8, operand_reg(MICRO_SIZE_32, dst.reg.reg), operand_reg(MICRO_SIZE_32, dst.reg.reg));
                goto exit;
            }
            ...
            push_asm_instr(MICRO_ASM386_INSTR_MOVZX_R32R8, operand_reg(MICRO_SIZE_32, free_reg), operand_reg(MICRO_SIZE_32, free_reg));
            ...
            if (dst.type == MICRO_STORAGE_DATASEC) {
                ...
                push_asm_instr(MICRO_ASM386_INSTR_MOV_S32R32, operand_imm(MICRO_SIZE_32, micro_imm_le_gen(dst.stack.ebp_offset)), operand_reg(MICRO_SIZE_32, free_reg));
            }
